...
function page() {
  ...
  return (
      <div style={{ backgroundImage: `url(${bgPic.src})`, backgroundSize: 'cover', backgroundPosition: 'center', width: '100vw', height: '100vh'}} className=" flex items-center justify-center bg-gray-100">
